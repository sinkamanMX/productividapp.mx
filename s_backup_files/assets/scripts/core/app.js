    ...
    return {
        ...
        blockUI: function (options) {
            ...
            if (options.iconOnly) {
                ...
                html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '')+'"><img style="" src="/assets/img/loading-spinner-grey.gif" align=""><span>&nbsp;&nbsp;' + (options.message ? options.message : 'CARGANDO...') + '</span></div>';
            }
